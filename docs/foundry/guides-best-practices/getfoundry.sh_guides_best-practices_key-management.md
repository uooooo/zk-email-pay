[Skip to content](https://getfoundry.sh/guides/best-practices/key-management#vocs-content)
...
This can be thought of as a middle ground between the above two approaches. With [`cast wallet import`](https://getfoundry.sh/cast/reference/wallet/import) you import a private key and encrypt it with a password. This still temporarily exposes your private key on your machine, but it becomes encrypted and you'll provide the password to decrypt it to run a script.
